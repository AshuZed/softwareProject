    ...
    return(
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit} className="forms">
                ...
                <input type="text" id="pID" onChange={handlePatientID} value={patientID} required />


                <label htmlFor="rID">Request ID</label>
                <input type="text" id="rID" onChange={handleRequstID} value={requestID} required />


                <label htmlFor="tname">Test Name</label>
                <input type="text" id="tname" onChange={handleTestName} value={testName}  />
                ...
                <div className="date-cont">
                    ...
                    <input type="number" id="month" onChange={handleMonth} value={month}  />
                    <input type="number" id="date" onChange={handleDate} value={date}  />
                    <input type="number" id="hour" onChange={handleHour} value={hour}  />
                    <input type="number" id="minute" onChange={handleMinute} value={minute}  />
                </div>

                <label htmlFor="ttype">Test Type</label>
                <input type="text" id="ttype" onChange={handleTestType} value={testType}  />

                <label htmlFor="value">Test Value</label>
                <input type="number" id="value" onChange={handkeValue} value={testValue}  />
                ...
                <input type="text" id="person" onChange={handlePerson} value={person}  required />
        ...
        <div>
            ...
            <ul>
                {testResult.map((result, index) =>
                    <li key={index}>
                        <h1></h1>
                        <div>{result.ctype} {result.ID} {result.tname} {result.tunit} </div>
                    </li> 
